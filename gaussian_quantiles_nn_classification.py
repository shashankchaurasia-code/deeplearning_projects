...
# https://github.com/chrismbryant/backpropagation/blob/master/2017_09_27%20Backpropagation%20Derivation%20(for%20Coursera%20Deep%20Learning).pdf
...
#print (np.random.seed(2)) # set a seed so that the results are consistent
...
plot_decision_boundary(lambda x: clf.predict(x), X, Y) # it just generates the contour plot below.
...
def initialize_parameters(n_x, n_h, n_y):
    ...
    params -- python dictionary containing your parameters:
                    ...
                    W2 -- weight matrix of shape (n_y, n_h)  (1,4)
                    b2 -- bias vector of shape (n_y, 1)      (1,1)
    """
...
parameters = nn_model(X, Y, n_h = 4, num_iterations = 8000, print_cost=1)
